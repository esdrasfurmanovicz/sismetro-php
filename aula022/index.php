        ...
        <form method="post">
            ...
            ?>
                ...
                <div class="result row">
                    ...
                    <div class="col-6">
                        <p>Valor</p>
                        <p class="resp"><?php echo fibonacci($_POST["iposic"]); ?></p>
                    </div>
                </div>
            <?php
            }
            ?>
            <div>
                <input type="text" name="iposic" id="posic" placeholder="Fibonacci" value="<?php if (isset($_POST["iposic"])) echo $_POST["iposic"]; ?>">
            </div> <br>
